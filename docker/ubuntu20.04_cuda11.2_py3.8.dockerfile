...
ENV SATSIM_VERSION='0.17.0'
COPY dist/satsim-0.17.0-py2.py3-none-any.whl /tmp
...
RUN pip3 --no-cache-dir install \
        ...
        tmp/satsim-0.17.0-py2.py3-none-any.whl
...
ENV SATSIM_VERSION='0.17.0'
COPY dist/satsim-0.17.0-py2.py3-none-any.whl /tmp
RUN pip3 install tmp/satsim-0.17.0-py2.py3-none-any.whl
