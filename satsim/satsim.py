        ...
        for frame_num in range(num_frames):
            ...
            with frame_profiler.time('objects'):
                r_obs_os, c_obs_os, pe_obs_os, obs_os_pix, obs_model = _gen_objects(ssp, render_mode,
                                                                                    ...
                                                                                    y_fov, x_fov,
                                                                                    y_to_pix, x_to_pix,
                                                                                    star_rot, astrometrics['track_mode'], track_apparent)
...
def _gen_objects(ssp, render_mode,
                 ...
                 y_fov, x_fov,
                 y_to_pix, x_to_pix,
                 star_rot, track_mode, track_apparent=True):
    ...
    track_deflection = enable_deflection if track_apparent is True else False
    track_aberration = enable_light_transit if track_apparent is True else False
