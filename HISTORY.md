...
* Add ePSF transform renderer performance options: budget-scaled scatter batches, `point_rendering: phase_nearest`, and detector-pixel auto temporal sampling with bin-centered exposure samples.
